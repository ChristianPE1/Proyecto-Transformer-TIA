...
ViTMNIST train_vit() {
    ...
    std::string train_images_path = data_path + "train-images.idx3-ubyte";
    std::string train_labels_path = data_path + "train-labels.idx1-ubyte";
    std::string test_images_path = data_path + "t10k-images.idx3-ubyte";
    std::string test_labels_path = data_path +"t10k-labels.idx1-ubyte";
